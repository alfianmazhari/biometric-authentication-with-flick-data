...
dirpath = '.';
datadirpath = '.\exp_result\FINAL_RESULT\DEFAULT_GAK_KAKEHAN_POLAH\0709\coba_retraining\sit_long_50negatives\sit_long';

allFiles = dir(datadirpath);
allNames = { allFiles.name };

for fileIndex = 2:(numel(allNames))
...
%                     end
            ...
            xlswrite([datadirpath '\totalEER_cobaRetraining50Neg_sitLong_0709_5.xlsx'],allavgeer,str,'A1');
            xlswrite([datadirpath '\totalEER_cobaRetraining50Neg_sitLong_0709_5.xlsx'],peopleROC,['zROC_' str],'A1');
        end
%     end
end